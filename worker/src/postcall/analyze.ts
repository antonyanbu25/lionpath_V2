// Post-call analysis — transcript in, structured summary + next steps + quality coach out.
...
7. artifacts — suggestedFollowUpEmail (subject+body) and crmNotes (collapsible in UI).
   Do NOT emit callNotes or MoM/minutes — Pass 7 (/api/postcall/summarise) owns those separately.
