...
REPO_URL="${REPO_URL:-https://github.com/kuttas246/se-singha-paathai.git}"
...
echo "       lionpath.benjaminsquare.com"
echo "       lionpathapi.benjaminsquare.com"
echo "  3. Start stack:     cd ${DEPLOY_DIR} && ./start.sh"
echo "  4. Verify:          curl -s https://lionpathapi.benjaminsquare.com/api/config | head"
echo ""
