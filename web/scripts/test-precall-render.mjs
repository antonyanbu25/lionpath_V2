...
const sampleV8 = {
  ...
  supportJD: { title: "Customer Support Specialist", sourceLabel: "S4", bullets: ["Handle tier-1 Zendesk tickets", "Update KB articles"] },
  evaluatorJD: { tools: ["Zendesk", "Salesforce"] },
  ...
  prospects: [
    {
      ...
      experienceSummary: "12 years B2B SaaS support leadership across manufacturing and tech",
    ...
    },
    {
      ...
      experienceSummary: "18 years customer success and support ops in enterprise SaaS",
...
const checks = [
  ...
  ["discovery prospect work experience", discovery.includes("Work experience")],
  ["discovery support JD tool highlight", discovery.includes("prep-jd-tool-highlight")],
