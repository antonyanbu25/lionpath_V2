...
const checks = [
  ...
  ["login theme toggle on page", html.includes("login-theme-toggle") && html.includes("data-theme-toggle")],
  ["login theme toggle not in card head", !/login-card-head[\s\S]*data-theme-toggle/.test(html)],
  ["Freshworks favicon", html.includes('rel="icon"') && html.includes("assets/freshworks-logomark.webp")],
  ["login video background", html.includes('class="login-bg-video"') && html.includes("assets/login-bg.webm")],
  ["login ambient background", html.includes("login-showcase") && html.includes('class="login-bg-overlay"')],
  ["login split layout", html.includes('class="login-form-panel"') && html.includes("login-showcase")],
