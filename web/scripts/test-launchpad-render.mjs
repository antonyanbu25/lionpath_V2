...
const checks = [
  ...
  ["task board has no quick-add form", !boardHtml.includes("task-quick-add")],
  ["task board has no 'What should I do now?' title", !boardHtml.includes("What should I do now?")],
  ["task board shows Recommended or empty state", boardHtml.includes("task-section-recommended") || boardHtml.includes("task-empty") || boardHtml.includes("task-board-empty")],
