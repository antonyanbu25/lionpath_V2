/**
 * thinking-orbs engine v0.3.1 — framework-free canvas animation core.
 * Vendored from https://github.com/Jakubantalik/thinking-orbs (npm: thinking-orbs,
 * dist/engine.es.js) by Jakub Antalik. MIT License — see thinking-orbs-LICENSE.txt
 * in this directory. Vendored verbatim so the vanilla JS app can use the animator
 * without pulling in React (the package's only peer dependency).
 */
function U(n, s, t) {
  return n + (s - n) * t;
}
