 ...
 * @typedef {{ videoFacts?: object[], timelineSegments?: object[], timelineMarkers?: object[], tcDeltas?: object[], meddpiccDeltas?: object[], objections?: object[], followUps?: object[], momDrafts?: object[], dealSignals?: object[], productGaps?: object[], whatWorks?: object[] }} PostCallDetailMap
 ...
 * @typedef {{ id: string, ownerId: string, ownerName?: string|null, teamId: string, orgId?: string|null, accountId: string, accountName?: string|null, dealId?: string|null, dealTitle?: string|null, dealStage?: string|null, dealType?: string|null, callType?: string|null, title?: string|null, aiShortForm?: string|null, createdAt: number, updatedAt: number, qualityScore?: number|null, qipOverall?: number|null, qipCategoryScores?: object|null, analysisConfidence?: number|null, provisional?: boolean, rubricVersion?: string|null, productsDiscussed?: string[], topGapKeys?: string[], followUpCount?: number, objectionCount?: number, hasVideoFacts?: boolean, searchTokens?: string[], embedding?: number[]|null }} CallSummaryDoc
