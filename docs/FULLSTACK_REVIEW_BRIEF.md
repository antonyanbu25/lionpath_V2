...
- **Cloud SQL / any relational DB** — the domain is doc-shaped (Lifecycle as aggregate root with linked artifacts), Firestore already fits and is already built against.
