...
| Tunnel URL down (lion.benjaminsquare.com) | VPS offline or DNS issue | Check `docker compose ps` on VPS — see docs/VPS_DEPLOY.md |
...
| What | Value |
|------|-------|
| Team portal URL | https://lion.benjaminsquare.com |
